export const metadata = {
  title: "Sliding Window DSA Problems | JDCodebase",
  description:
      ...
      <main className="flex-1 px-6 py-4 md:p-6">
        <section className="py-8 max-w-4xl mx-auto text-gray-100">
          ...
          <p className="mb-4">
            ...
            from O(n²) to O(n) in many real-world DSA problems.
          </p>
          ...
          <p className="mb-4">
            It’s a technique where you maintain a window (subarray or substring)
            that slides over the input data to process only the required portion
            at a time. You either:
          </p>
          ...
          <ul className="list-disc list-inside mb-6 space-y-1">
            <li>Subarrays/substrings with max/min sum, length, or frequency</li>
            <li>Count of distinct/repeating elements in a window</li>
            <li>Checking existence of patterns in a range (e.g., anagrams)</li>
            <li>
