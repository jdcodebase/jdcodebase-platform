        ...
        <main className="flex-1 px-6 py-4 md:p-6">
          <section className="py-8 max-w-4xl mx-auto text-gray-100">
            ...
            <p className="mb-4">
              ...
              real-world tasks like data processing, searching, and
              optimization. Understanding different sorting techniques helps in
            ...
            <p className="mb-4">
              - Choose the right sorting technique based on time and space
              needs.
              <br />
            ...
            <ol className="list-decimal list-inside mb-6 space-y-3">
              <li>
                <strong>Bubble Sort:</strong> Repeatedly swaps adjacent
                elements. Easy to understand but slow (O(n²)).
              </li>
              <li>
              ...
              <li>
                <strong>Insertion Sort:</strong> Builds the final sorted array
                one element at a time. Great for small or nearly sorted arrays.
              </li>
              <li>
                <strong>Merge Sort:</strong> Divide and conquer approach that
                splits the array and merges it back sorted. Stable and
