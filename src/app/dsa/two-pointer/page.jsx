        ...
        <main className="flex-1 px-6 py-4 md:p-6">
          <section className="py-8 max-w-4xl mx-auto text-gray-100">
            ...
            <p className="mb-4">
              ...
              reduce time complexity in array and string problems. It helps
              avoid nested loops and makes your solution more efficient.
            </p>
            ...
            <ul className="list-disc list-inside mb-6 space-y-2">
              ...
              <li>
                ...
                beginning and one lags behind the other. This is common in
