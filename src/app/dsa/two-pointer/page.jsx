export const metadata = {
  title: "Two Pointer DSA Problems | JDCodebase",
  description:
    "Learn the two pointer technique to solve efficient DSA problems. Practice sorting, searching, and pointer movement strategies.",
};
